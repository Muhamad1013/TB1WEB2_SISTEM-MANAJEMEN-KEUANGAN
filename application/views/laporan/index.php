      ...
      <form action="<?php echo site_url('laporan/filter'); ?>" method="post">
        <div class="filter-laporan-box">
          ...
          <div class="flex-laporan">
            <label for="mulai_tanggal">Mulai Tanggal <input type="date" id="mulai_tanggal" name="mulai_tanggal"
                required></label>
            <label for="sampai_tanggal">Sampai Tanggal <input type="date" id="sampai_tanggal" name="sampai_tanggal"
                required></label>
            <label for="filter">Filter <select name="filter" id="filter">
